...
public class test_graph {
	...
	public static void main(String[]args) {
		...
		SparseGraph_tree_map g1 =new SparseGraph_tree_map(13,false);  // 13个节点，而且是一个五香图
       ...
       // System.out.println(g1.adj(6));
        ...
        Path_test pt= new Path_test(g1,0);
     ...
     // ---------------------------------------------------------------------------
       ...
       // g4.show();
        ...
        SparseGraph_tree_map g6=new SparseGraph_tree_map  (7,true);
