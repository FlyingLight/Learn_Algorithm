 ...
 *
 */
public class All_Pathes_BFS_Test {

	/**
	 * @param args
	 */
	
	private BFS_Path_test[] pathes;
	
	private Graph graph;
	
	public All_Pathes_BFS_Test(Graph graph) {
		
		
		this.graph=graph;
		
		pathes= new BFS_Path_test[graph.V()];
		
		for(int v=0;v<graph.V();v++)
			
			pathes[v]=new BFS_Path_test(graph,v);
	...
	public static void main(String[] args) {
		 ...
		 All_Pathes_BFS_Test apt = new  All_Pathes_BFS_Test(g3);
